...
class _$_WeatherModel implements _WeatherModel {
  const _$_WeatherModel({this.location = const LocationModel()});
  ...
  @override
  String toString() {
    return 'WeatherModel(location: $location)';
  }
...
abstract class _WeatherModel implements WeatherModel {
  const factory _WeatherModel({final LocationModel location}) = _$_WeatherModel;
